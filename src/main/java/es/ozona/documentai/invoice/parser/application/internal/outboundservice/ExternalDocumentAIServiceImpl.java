...
@Service
public class ExternalDocumentAIServiceImpl implements ExternalDocumentAIService {

	private static final Logger LOG = LoggerFactory.getLogger(ExternalDocumentAIServiceImpl.class);
	...
	@Value("${documentai.processor.location}")
	private String location;

	@Value("${documentai.processor.projectid}")
	private String projectId;

	@Value("${documentai.processor.processorid}")
